...
public class JDBCSingleton {
    ...
    //JDBCSingleton prevents the instantiation from any class
    private JDBCSingleton(){};

    //now are providing global point of access
    ...
    public int insert(String name, String pass) throws SQLException, ClassNotFoundException {
        Connection c = null;
    ...
    public int update(String name, String password) throws SQLException, ClassNotFoundException {
        Connection con = null;
        PreparedStatement ps = null;
        int recordCounter = 0;
        try{
    ...
    public int delete(int id) throws SQLException, ClassNotFoundException{
        ...
        try{
            con = this.getConnection();
            ps = con.prepareStatement("delete from userdata where id= "+id+" ");
            recordCounter = ps.executeUpdate();
        }catch (Exception e){
            e.printStackTrace();
        }finally {
